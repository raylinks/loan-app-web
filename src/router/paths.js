export default [
    ...
    { path: "/loan-request", component: () => import("@/views/LoanRequest"), meta: { layout: "default" } },
    { path: "/transaction-page", component: () => import("@/views/TransactionPage"), meta: { layout: "default" } },
